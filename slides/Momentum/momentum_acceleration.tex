...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item If objective is \textbf{structured}: $f+g$ \textcolor{gray}{(smooth+nonsmooth)}
          \begin{align}
            y_{k} &= x_k + \beta_k (x_k - x_{k-1}) \\
...
\begin{frame}
  ...
  \begin{itemize}
    \item In theory: difficult to show benefit of momentum in for nonconvex problems.
    \begin{itemize}
